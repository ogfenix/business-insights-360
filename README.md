...
- Consolidate data from multiple sources (MySQL, Excel, CSV)  
- Build a robust **data model** for cross-functional analysis  
- Provide **executive-level KPIs** for top management decision-making  
- Deliver **interactive dashboards** for Sales, Finance, Marketing, and Supply Chain teams  
- Create a **homepage navigation system** for seamless access to reports  
...
👉 [Live Power BI Dashboard](https://app.powerbi.com/view?r=eyJrIjoiODVkODU2ZWMtN2Q0NS00ODJmLWFjN2ItNDFjZjdkZTQ5YjFmIiwidCI6ImM2ZTU0OWIzLTVmNDUtNDAzMi1hYWU5LWQ0MjQ0ZGM1YjJjNCJ9)
